...
function VideoPlayer() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://www.googleapis.com/youtube/v3/videos?part=snippet%2C%20statistics&id=${videoId}&key=AIzaSyDIPxFUAnRd6ZacRdJhHXbCfkwjf711EcQ`
      )
      .then((response) => {
  ...
  async function createVideoInfo(video) {
    ...
    const response = await axios.get(
      `https://www.googleapis.com/youtube/v3/channels?part=snippet%2C%20statistics&id=${channelId}&key=AIzaSyDIPxFUAnRd6ZacRdJhHXbCfkwjf711EcQ`
    );
